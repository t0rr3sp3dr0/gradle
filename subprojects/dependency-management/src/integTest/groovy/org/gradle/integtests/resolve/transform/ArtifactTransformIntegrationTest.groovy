...
class ArtifactTransformIntegrationTest extends AbstractHttpDependencyResolutionTest {
    ...
    private static String getFileSizer() {
        """
            abstract class FileSizer implements org.gradle.api.artifacts.transform.TransformAction<org.gradle.api.artifacts.transform.TransformParameters.None> {
                FileSizer() {
