...
class DistributionIntegritySpec extends DistributionIntegrationSpec {
    ...
    def "verify 3rd-party dependencies jar hashes"() {
        ...
        def expectedHashes = [
            ...
            'plugins/httpclient-4.5.9.jar' : '6c7e3bb423d8c5574f28157fe42b4c38d6a3477bfa2954cfe5f330b14ecad8a9',
            'plugins/httpcore-4.4.11.jar' : 'd799522d579aac06b170603f8f080f6e3248dadc01f9652cdd7ea7bc318c21ce',
